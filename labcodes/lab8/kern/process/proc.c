...
alloc_proc(void) {
     ...
     */
     ...
     //LAB5 2015011372 : (update LAB4 steps)
    /*
	 ...
	 */
        ...
        proc->yptr = NULL;
        proc->optr = NULL;
     //LAB6 2015011372 : (update LAB5 steps)
    /*
    ...
    //LAB8:EXERCISE2 2015011372 HINT:need add some code to init fs in proc_struct, ...
        proc->filesp = NULL;
    }
    return proc;
}
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    //LAB8:EXERCISE2 2015011372  HINT:how to copy the fs in parent's proc_struct?
    /*
    ...
    proc->parent = current;
    assert(current->wait_state == 0); // [ANSWER]
